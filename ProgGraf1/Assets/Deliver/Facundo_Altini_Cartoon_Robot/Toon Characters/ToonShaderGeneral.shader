...
Shader "Robotardo"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float Steps20 = ( ( step( (0.0 + (_ShadowStrength1 - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) , dotResault29 ) + step( (0.0 + (_ShadowStrength2 - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) , dotResault29 ) ) / 2.0 );
			float4 lerpResult21 = lerp( _Color1 , _Color0 , Steps20);
			c.rgb = ( ase_lightColor * lerpResult21 ).rgb;
			c.a = _Float0;
			return c;
		}
...
/*ASEBEGIN
Version=18900
0;485;1465;506;1999.164;955.4672;2.105777;True;True
Node;AmplifyShaderEditor.TexturePropertyNode;24;-2160.766,-486.5722;Inherit;True;Property;_Texture0;Texture 0;5;0;Create;True;0;0;0;False;0;False;None;None;True;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode;38;-1925.319,-483.6087;Inherit;True;Property;_TextureSample0;Texture Sample 0;7;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldNormalVector;27;-1559.398,-488.5058;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;26;-1584.95,-710.8195;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;11;-1444.632,-136.7111;Inherit;False;Property;_ShadowStrength1;ShadowStrength1;0;0;Create;True;0;0;0;False;0;False;0;0.151;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-1442.903,221.5992;Inherit;False;Property;_ShadowStrength2;ShadowStrength2;3;0;Create;True;0;0;0;False;0;False;0;-0.24;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;13;-1109.381,225.3509;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;12;-1102.582,389.887;Inherit;False;29;dotResault;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;14;-1081.034,39.00483;Inherit;False;29;dotResault;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;15;-1087.523,-129.7432;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;23;-468.9099,-589.7923;Inherit;False;Property;_Color1;Color 1;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;22;-415.3071,-161.3435;Inherit;False;20;Steps;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;7;-462.1116,-371.567;Inherit;False;Property;_Color0;Color 0;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LightColorNode;39;-160.8183,-736.4666;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
ASEEND*/
//CHKSM=C428A9435CACE86D398F10F147E95BB4E90B935B