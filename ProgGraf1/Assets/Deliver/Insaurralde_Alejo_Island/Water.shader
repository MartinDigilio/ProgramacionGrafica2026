...
Shader "Water"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 color89 = IsGammaSpace() ? float4(0,0.5764706,0.8666667,1) : float4(0,0.2917707,0.7230552,1);
			float temp_output_46_0 = ( _Time.y * _WaveSpeed );
...
/*ASEBEGIN
Version=18900
0;73.6;956.6;364.6;3317.182;631.0438;4.425054;True;False
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;67;-1320.988,1004.474;Inherit;True;Simplex2D;False;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;77;-287.9088,278.9941;Inherit;False;76;WaveHeight;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;79;-157.4836,99.86334;Inherit;False;Property;_Smoothness;Smoothness;6;0;Create;True;0;0;0;False;0;False;0.9;0.9;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;96;-208.3234,-236.143;Inherit;True;95;Albedo;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;85;-512.1924,-27.26469;Inherit;True;Property;_TextureSample0;Texture Sample 0;7;0;Create;True;0;0;0;False;0;False;-1;None;cf284971540584c4ab7df95b708547e4;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=33F441D72418A005FF0CD45A8A2BEA6EDE163CC9