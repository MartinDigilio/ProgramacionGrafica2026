	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 tex2DNode65_g1 = tex2D( _Normal, MainUvs222_g1 );
				float4 appendResult82_g1 = (float4(0.0 , tex2DNode65_g1.g , 0.0 , tex2DNode65_g1.r));
				float2 temp_output_84_0_g1 = (UnpackScaleNormal( appendResult82_g1, frac( ( _Scale * _Time.y ) ) )).xy;
...
/*ASEBEGIN
Version=18900
0;73.6;834.2;363.8;1344.173;157.0445;1.800173;True;False
Node;AmplifyShaderEditor.SimpleTimeNode;14;-736.6757,352.8545;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-892.4786,242.9635;Inherit;False;Property;_Scale;Scale;7;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-523.4757,324.2544;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=190C83D7AB293C07B3CB479E521145A8DE1F091D