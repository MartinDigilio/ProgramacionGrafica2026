...
Shader "FoilCardFrameTexture"
{
	Properties
	{
		...
		_ParallaxShift("Parallax Shift", Float) = 0
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 uv_TexCoord19 = i.uv_texcoord + ( temp_output_13_0 * _ParallaxShift );
			float4 tex2DNode2 = tex2D( _FrontTexture, uv_TexCoord19 );
			float3 unityObjectToViewPos37 = UnityObjectToViewPos( float3( temp_output_13_0 ,  0.0 ) );
			float simplePerlin2D24 = snoise( ( float3( ( uv_TexCoord19 * _HoloTiling ) ,  0.0 ) + ( unityObjectToViewPos37 * _holospeed ) ).xy );
			simplePerlin2D24 = simplePerlin2D24*0.5 + 0.5;
			float2 temp_cast_4 = (simplePerlin2D24).xx;
			float2 uv_TextureSample2 = i.uv_texcoord * _TextureSample2_ST.xy + _TextureSample2_ST.zw;
			float4 lerpResult30 = lerp( float4( (tex2DNode2).rgb , 0.0 ) , ( tex2DNode2 + ( tex2D( _TextureSample3, temp_cast_4 ) * tex2D( _TextureSample2, uv_TextureSample2 ).r ) ) , float4( ( i.viewDir * _HoloIntensity ) , 0.0 ));
...
/*ASEBEGIN
Version=18900
0;73.6;825.4;502.2;2052.671;-598.021;1.946053;True;False
Node;AmplifyShaderEditor.CommentaryNode;41;-2649.024,741.2195;Inherit;False;2020.303;665.6426;Efecto holografico;17;12;13;14;37;15;17;16;36;19;21;20;22;24;34;33;28;51;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-2205.847,930.3347;Inherit;False;Property;_ParallaxShift;Parallax Shift;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-2206.064,817.0679;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;19;-2059.517,791.2195;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;17;-2098.22,1066.962;Inherit;False;Property;_HoloTiling;HoloTiling;4;0;Create;True;0;0;0;False;0;False;2;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-1899.704,1233.127;Inherit;False;Property;_holospeed;holospeed;5;0;Create;True;0;0;0;False;0;False;0.1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-1733.303,1111.528;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;22;-1625.303,979.5272;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CommentaryNode;38;-1862.309,33.77076;Inherit;False;1032.538;285.0924;Textura frontal ;6;2;3;29;30;27;45;;1,1,1,1;0;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;24;-1509.138,1164.363;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;51;-1611.493,894.9424;Inherit;True;Property;_TextureSample3;Texture Sample 3;8;0;Create;True;0;0;0;False;0;False;-1;53dcaa3c106af184cbda2f24c4a6ec59;5d6b6735fae951f40a27a6b1ffd38534;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;34;-1220.78,1154.988;Inherit;True;Property;_TextureSample2;Texture Sample 2;7;0;Create;True;0;0;0;False;0;False;-1;4e48330f1683f9d4584dcb0a9890d972;4e48330f1683f9d4584dcb0a9890d972;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;3;-1812.309,88.8632;Inherit;True;Property;_FrontTexture;Front Texture;0;0;Create;True;0;0;0;False;0;False;None;a1ce2e435936c6e498c056cbfdf06c52;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.WireNode;46;-2422.79,650.4058;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-1182.576,258.766;Inherit;False;Property;_HoloIntensity;HoloIntensity;6;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;-1155.24,164.5984;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;8;-1372.677,383.7994;Inherit;True;Property;_Backtexture;Back texture;2;0;Create;True;0;0;0;False;0;False;None;6a3028354918d9c4babc90d154170b3f;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.LerpOp;30;-1011.772,90.26878;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=11F615407174F1DEBB6EEE27D80E32FA5847FD6F