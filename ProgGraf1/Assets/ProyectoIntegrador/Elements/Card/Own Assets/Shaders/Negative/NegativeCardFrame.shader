...
Shader "NegativeCardFrameTexture"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 tex2DNode2 = tex2D( _FrontTexture, i.uv_texcoord );
			float2 temp_output_13_0 = (i.viewDir).xy;
			float3 unityObjectToViewPos37 = UnityObjectToViewPos( float3( temp_output_13_0 ,  0.0 ) );
			float4 lerpResult30 = lerp( float4( ( 1.0 - (tex2DNode2).rgb ) , 0.0 ) , ( tex2DNode2 + tex2D( _TextureSample3, ( ( i.uv_texcoord * _HoloTiling ) + ( (unityObjectToViewPos37).xy * _holospeed ) ) ) ) , float4( ( i.viewDir * _HoloIntensity ) , 0.0 ));
...
/*ASEBEGIN
Version=18900
0;73.6;825.4;502.2;2297.559;-1036.936;1.031462;True;False
Node;AmplifyShaderEditor.CommentaryNode;41;-2649.024,741.2195;Inherit;False;2020.303;665.6426;Efecto holografico;14;12;13;14;37;15;17;16;36;19;21;20;22;28;51;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-1899.704,1233.127;Inherit;False;Property;_holospeed;holospeed;5;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;38;-2079.568,21.58804;Inherit;False;1032.538;285.0924;Textura frontal ;6;2;3;29;27;45;54;;1,1,1,1;0;0
Node;AmplifyShaderEditor.TexturePropertyNode;3;-2029.566,76.68049;Inherit;True;Property;_FrontTexture;Front Texture;0;0;Create;True;0;0;0;False;0;False;None;a1ce2e435936c6e498c056cbfdf06c52;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;27;-1200.85,250.6442;Inherit;False;Property;_HoloIntensity;HoloIntensity;6;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;51;-1220.698,950.9871;Inherit;True;Property;_TextureSample3;Texture Sample 3;7;0;Create;True;0;0;0;False;0;False;-1;c317c95413d37f842bdf057c59a4fa78;5d6b6735fae951f40a27a6b1ffd38534;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;-1197.434,161.6766;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.OneMinusNode;54;-1193.403,73.23445;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;30;-1032.076,74.02515;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=2B4595A306A1D4A11A808093B95697F9856DFE3C